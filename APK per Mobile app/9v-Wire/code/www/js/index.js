...
var app = {
    ...
    bindEvents: function() {
		...
		setstatus_TA_2.addEventListener("touchstart", this.sendData_setstatus_TA_2, false);	
		...
		setstatus_TB_2.addEventListener("touchstart", this.sendData_setstatus_TB_2, false);	
    ...
    onData: function(data) { // data received from Arduino
		...
		resultDiv.innerHTML = resultDiv.innerHTML + "" +  datetime + " " +  "-->" + data + "<br/>";			
    },
