...
int speedB = 170; //150 velocità treno tracciato 2 (mai sotto 80 sennò non parte)
  ...
  while (Serial.available() == 0){
    ...
    switch (state)
    {
        ...
        case TRACK_SECTION_CLEAR:  //both light sensors off, power to both trains
        {
          ...
          if (myTrains[1].stato==1)partiTreno(myTrains[1].tracciato,myTrains[1].speedT);
          if (myTrains[2].stato==1)partiTreno(myTrains[2].tracciato,myTrains[2].speedT);
